...
*Shredder* is a free Open Source plugin emulating the Shredder pedal.

image::Shredder.png[GUI]
...
There are a few advanced parameters that are not available on a regular Shredder pedal and thus are not accessible through the UI:
...
There shouldn’t be bugs, but you never know. Please contact me or leave a message on http://www.audio-tk.com[Audio ToolKit web site] or on http://blog.audio-tk.com/tags/shredder/[my blog, on the announcement page].

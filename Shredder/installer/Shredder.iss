...
DefaultDirName={pf}\Shredder
DefaultGroupName=Shredder
Compression=lzma2
SolidCompression=yes
OutputDir=.\
ArchitecturesInstallIn64BitMode=x64
OutputBaseFilename=Shredder Installer
...
[Files]
Source: "..\Builds\VisualStudio2019_32\Win32\Release\VST3\Shredder.vst3"; DestDir: "{cf}\VST3\"; Check: not Is64BitInstallMode; Components:vst3_32; Flags: ignoreversion;
Source: "..\Builds\VisualStudio2019_32\Win32\Release\VST3\Shredder.vst3"; DestDir: "{cf32}\VST3\"; Check: Is64BitInstallMode; Components:vst3_32; Flags: ignoreversion;
Source: "..\Builds\VisualStudio2019\x64\Release\VST3\Shredder.vst3"; DestDir: "{cf64}\VST3\"; Check: Is64BitInstallMode; Components:vst3_64; Flags: ignoreversion;

;Source: "..\Builds\VisualStudio2019_32\Win32\Release\aax\Shredder.aaxplugin\*.*"; DestDir: "{cf32}\Avid\Audio\Plug-Ins\Shredder.aaxplugin\"; Components:aax_32; Flags: ignoreversion recursesubdirs;
;Source: "..\Builds\VisualStudio2019\x64\Release\aax\Shredder.aaxplugin\*.*"; DestDir: "{cf}\Avid\Audio\Plug-Ins\Shredder_x64.aaxplugin\"; Components:aax_64; Flags: ignoreversion recursesubdirs;

Source: "..\manual\Shredder_manual.pdf"; DestDir: "{app}"
Source: "changelog.txt"; DestDir: "{app}"
Source: "readmewin.rtf"; DestDir: "{app}"; DestName: "readme.rtf"; Flags: isreadme

[Icons]
Name: "{group}\Shredder"; Filename: "{app}\Shredder.exe"
Name: "{group}\User guide"; Filename: "{app}\Shredder_manual.pdf"
Name: "{group}\Changelog"; Filename: "{app}\changelog.txt"
Name: "{group}\Uninstall Shredder"; Filename: "{app}\unins000.exe"

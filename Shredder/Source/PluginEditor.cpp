...
//==============================================================================
ShredderAudioProcessorEditor::ShredderAudioProcessorEditor(ShredderAudioProcessor& p, juce::AudioProcessorValueTreeState& paramState)
...
ShredderAudioProcessorEditor::~ShredderAudioProcessorEditor() = default;

void ShredderAudioProcessorEditor::paint(juce::Graphics& g)
{
  g.drawImageAt(bckgndImage, 0, 0);
  g.setFont(juce::Font("Times New Roman", 30.0f, juce::Font::bold | juce::Font::italic));
  g.setColour(juce::Colours::whitesmoke);
  g.drawText("Shredder", 20, 10, 200, 30, juce::Justification::verticallyCentred);
...
void ShredderAudioProcessorEditor::resized()
{

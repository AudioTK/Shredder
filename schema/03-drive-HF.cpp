...
public:
  ...
  void setup_inverse()
  {
    ...
    auto jac1_1 = 0 - (steady_state ? 0 : c031.get_gradient()) - r042.get_gradient() - (steady_state ? 0 : c029.get_gradient()) - r045.get_gradient();
...
bool iterate() const
{
   ...
   auto  i0_= input_state[0];
    ...
    auto eq1 = + (steady_state ? 0 : c031.get_current(d1_, s0_)) + r042.get_current(d1_, s0_) + (steady_state ? 0 : c029.get_current(d1_, d0_)) - r045.get_current(i0_, d1_);
    eqs << eq0, eq1;

...
//==============================================================================
BShredderAudioProcessorEditor::BShredderAudioProcessorEditor(BShredderAudioProcessor& p, juce::AudioProcessorValueTreeState& paramState)
...
BShredderAudioProcessorEditor::~BShredderAudioProcessorEditor() = default;

void BShredderAudioProcessorEditor::paint(juce::Graphics& g)
{
  g.drawImageAt(bckgndImage, 0, 0);
  g.setFont(juce::Font("Times New Roman", 30.0f, juce::Font::bold | juce::Font::italic));
  g.setColour(juce::Colours::whitesmoke);
  g.drawText("BShredder", 20, 10, 200, 30, juce::Justification::verticallyCentred);
...
void BShredderAudioProcessorEditor::resized()
{

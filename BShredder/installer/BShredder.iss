...
DefaultDirName={pf}\BShredder
DefaultGroupName=BShredder
Compression=lzma2
SolidCompression=yes
OutputDir=.\
ArchitecturesInstallIn64BitMode=x64
OutputBaseFilename=BShredder Installer
...
[Files]
Source: "..\Builds\VisualStudio2019_32\Win32\Release\VST3\BShredder.vst3"; DestDir: "{cf}\VST3\"; Check: not Is64BitInstallMode; Components:vst3_32; Flags: ignoreversion;
Source: "..\Builds\VisualStudio2019_32\Win32\Release\VST3\BShredder.vst3"; DestDir: "{cf32}\VST3\"; Check: Is64BitInstallMode; Components:vst3_32; Flags: ignoreversion;
Source: "..\Builds\VisualStudio2019\x64\Release\VST3\BShredder.vst3"; DestDir: "{cf64}\VST3\"; Check: Is64BitInstallMode; Components:vst3_64; Flags: ignoreversion;

;Source: "..\Builds\VisualStudio2019_32\Win32\Release\aax\BShredder.aaxplugin\*.*"; DestDir: "{cf32}\Avid\Audio\Plug-Ins\BShredder.aaxplugin\"; Components:aax_32; Flags: ignoreversion recursesubdirs;
;Source: "..\Builds\VisualStudio2019\x64\Release\aax\BShredder.aaxplugin\*.*"; DestDir: "{cf}\Avid\Audio\Plug-Ins\BShredder_x64.aaxplugin\"; Components:aax_64; Flags: ignoreversion recursesubdirs;

Source: "..\manual\BShredder_manual.pdf"; DestDir: "{app}"
Source: "changelog.txt"; DestDir: "{app}"
Source: "readmewin.rtf"; DestDir: "{app}"; DestName: "readme.rtf"; Flags: isreadme

[Icons]
Name: "{group}\BShredder"; Filename: "{app}\BShredder.exe"
Name: "{group}\User guide"; Filename: "{app}\BShredder_manual.pdf"
Name: "{group}\Changelog"; Filename: "{app}\changelog.txt"
Name: "{group}\Uninstall BShredder"; Filename: "{app}\unins000.exe"
